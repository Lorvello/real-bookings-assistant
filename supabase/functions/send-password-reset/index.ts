...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // Extract the reset URL with proper tokens - USE ORIGINAL SUPABASE URL
    ...
    console.log("🔗 Using original Supabase reset URL:", resetUrl);
    console.log("🔗 Reset URL domain:", new URL(resetUrl).origin);
    console.log("🔗 Reset URL path:", new URL(resetUrl).pathname);
    console.log("🔗 Reset URL search params:", new URL(resetUrl).search);
