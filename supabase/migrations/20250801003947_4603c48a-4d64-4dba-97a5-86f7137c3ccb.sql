-- Create function to completely reset user to setup incomplete state with mock data
...
BEGIN
  ...
  -- Reset user to setup incomplete state
  UPDATE public.users 
  SET 
  ...
  RETURN jsonb_build_object(
    'success', true,
    'message', 'User successfully reset to setup incomplete state',
