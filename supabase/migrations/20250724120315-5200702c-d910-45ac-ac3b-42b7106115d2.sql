...
DROP POLICY IF EXISTS "Users can manage whatsapp templates for their calendars" ON public.whatsapp_templates;
...
DROP POLICY IF EXISTS "System can manage whatsapp webhook queue" ON public.whatsapp_webhook_queue;
