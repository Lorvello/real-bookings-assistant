-- LR-R94: get_available_slots gebruikte raw EXTRACT(DOW) (0-6, Zo=0) terwijl
-- availability_rules.day_of_week ISODOW 1-7 (Zo=7) opslaat -> zondag onbereikbaar.
-- (De andere slot-functies converteren al via CASE; de 5-arg range delegeert hierheen.)
-- Fix: EXTRACT(ISODOW) zodat zondag (7) matcht. Ma-za (1-6) ongewijzigd.
