-- Fix day_of_week validation in admin_generate_mock_data function
...
BEGIN
  ...
  -- Add Saturday (6) and Sunday (7) as unavailable
  INSERT INTO public.availability_rules (schedule_id, day_of_week, start_time, end_time, is_available)
  VALUES 
    (v_schedule_id, 6, '00:00', '00:00', false),
    (v_schedule_id, 7, '00:00', '00:00', false);  -- Fixed: was 0, now 7
