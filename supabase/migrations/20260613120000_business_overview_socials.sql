-- LR-R69 (agent-scope, website-audit high): socials tiktok/youtube/x bereikten de agent niet.
-- users had de kolommen, maar business_overview (agent-kennis) projecteerde alleen
-- website/instagram/facebook/linkedin. Voeg tiktok/youtube/x toe + projecteer ze.

ALTER TABLE public.business_overview ADD COLUMN IF NOT EXISTS tiktok text;
ALTER TABLE public.business_overview ADD COLUMN IF NOT EXISTS youtube text;
ALTER TABLE public.business_overview ADD COLUMN IF NOT EXISTS x text;
