-- Fix remaining database function security warnings by adding SET search_path = ''
...
-- Exclude materialized views from public API access
COMMENT ON MATERIALIZED VIEW public.daily_booking_stats IS '@exclude';
COMMENT ON MATERIALIZED VIEW public.service_popularity_stats IS '@exclude';