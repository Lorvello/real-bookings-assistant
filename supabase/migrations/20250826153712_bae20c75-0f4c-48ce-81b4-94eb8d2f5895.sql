-- Fix remaining security functions that still need search_path
...
COMMENT ON VIEW public.daily_booking_stats IS '@exclude';
COMMENT ON VIEW public.service_popularity_stats IS '@exclude';
COMMENT ON VIEW public.user_status_overview IS '@exclude';