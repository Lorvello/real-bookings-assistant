...
const SeeHowItWorks = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 py-12 md:py-20 px-3 md:px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 px-4 md:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 px-3 sm:px-0 tracking-tight">
            How does <span className="bg-gradient-to-r from-slate-300 to-slate-100 bg-clip-text text-transparent">it work?</span>
          </h1>
          <p className="text-base md:text-lg text-slate-300 max-w-4xl mx-auto mb-8 md:mb-12 px-3 sm:px-0 leading-relaxed font-light">
