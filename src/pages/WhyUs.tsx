...
const WhyUs = () => {
  ...
  const competitorComparison = [{
    feature: "24/7 Instant Response",
    us: true,
    traditional: false
  }, {
    feature: "No Human Errors",
    us: true,
    traditional: false
  }, {
    feature: "Unlimited Capacity",
    us: true,
    traditional: false
  }, {
  ...
  return <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 px-4 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {proofPoints.map((stat, index) => <div key={index} className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700 text-center">
      ...
      <section className="py-20 px-4 bg-red-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {painPoints.map((pain, index) => <div key={index} className="bg-white p-8 rounded-2xl border-2 border-red-200">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => <div key={index} className="bg-green-50 p-8 rounded-2xl border-2 border-green-200 hover:border-green-300 transition-all">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            {competitorComparison.map((item, index) => <div key={index} className="grid md:grid-cols-3 gap-8 py-4 border-b border-gray-200 items-center">
                <div className="font-medium text-gray-900">{item.feature}</div>
                <div className="text-center">
                  {item.us ? <CheckCircle className="w-8 h-8 text-green-600 mx-auto" /> : <div className="w-8 h-8 text-red-600 mx-auto">❌</div>}
                </div>
                <div className="text-center">
                  {item.traditional ? <CheckCircle className="w-8 h-8 text-green-600 mx-auto" /> : <div className="w-8 h-8 text-red-600 mx-auto">❌</div>}
                </div>
              </div>)}
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <div key={index} className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
