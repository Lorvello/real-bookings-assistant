...
const nlKeys = new Set<string>([
  ...
  ...flattenKeys(nlAbout as Record<string, unknown>),
  ...flattenKeys(nlFaq as Record<string, unknown>),
  ...flattenKeys(nlContact as Record<string, unknown>),
  ...flattenKeys(nlTerms as Record<string, unknown>),
  ...
  ...flattenKeys(nlPublicBooking as Record<string, unknown>),
  ...flattenKeys(nlAuth as Record<string, unknown>),
  ...flattenKeys(nlNotFound as Record<string, unknown>),
  ...flattenKeys(nlPayment as Record<string, unknown>),
  ...flattenKeys(nlApp as Record<string, unknown>),
