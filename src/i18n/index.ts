...
i18n.use(initReactI18next).init({
  ...
  fallbackLng: 'en',
  defaultNS: 'common',
  ns: ['common', 'home', 'howItWorks', 'whyUs', 'about', 'faq', 'contact', 'terms', 'privacy', 'blog', 'blogArticle', 'businessSearch', 'publicBooking', 'auth', 'notFound', 'payment', 'app', 'dashboard', 'settings'],
