...
const Hero = () => {
  return (
    <section className="relative min-h-[80vh] md:min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 overflow-hidden flex items-center justify-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        {/* Floating badge */}
        <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-3 py-1 md:px-6 md:py-3 mb-3 md:mb-8 animate-appear opacity-0">
        ...
        {/* Main headline - Compact mobile approach */}
        <div className="space-y-3 md:space-y-8">
          ...
          <p className="text-sm md:text-xl lg:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed animate-appear opacity-100 delay-300 px-2 md:px-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-6 pt-4 md:pt-8 animate-appear opacity-100 delay-500 px-4 sm:px-0">
            ...
            <button className="w-full sm:w-auto text-slate-300 hover:text-white text-base md:text-lg font-medium flex items-center justify-center gap-2 group transition-colors min-h-[44px] px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-8 pt-3 md:pt-4 animate-appear opacity-100 delay-700 px-4 sm:px-0">
