      ...
      case 'hero':
        return {
          ...
          background: `
            ...
            radial-gradient(ellipse 45% 35% at top left, rgba(16, 185, 129, 0.75), transparent 65%),
            radial-gradient(ellipse 45% 35% at top right, rgba(5, 150, 105, 0.75), transparent 65%)
          `,
