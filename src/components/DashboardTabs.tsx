    ...
    <div className="space-y-8">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="relative mb-8">
          <div className="absolute -inset-2 bg-gradient-to-r from-primary/20 via-purple-500/15 to-primary/20 blur-xl"
               style={{
                 borderRadius: '3rem 6rem 3rem 6rem / 2rem 4rem 2rem 4rem'
               }}></div>
          
          <TabsList className="relative grid w-full grid-cols-4 bg-gradient-to-br from-card/95 via-card/80 to-card/70 backdrop-blur-2xl border border-primary/30 shadow-2xl p-2 h-auto"
                    style={{
                      borderRadius: '2rem 4rem 2rem 4rem / 1.5rem 2.5rem 1.5rem 2.5rem'
                    }}>
            <TabsTrigger value="live-ops" 
                        ...
                        style={{
                          borderRadius: activeTab === 'live-ops' ? '1rem 2rem 1rem 2rem / 1rem 1.5rem 1rem 1.5rem' : '1rem'
                        }}>
            ...
            <TabsTrigger value="business-intel"
                        ...
                        style={{
                          borderRadius: activeTab === 'business-intel' ? '1rem 2rem 1rem 2rem / 1rem 1.5rem 1rem 1.5rem' : '1rem'
                        }}>
            ...
            <TabsTrigger value="performance"
                        ...
                        style={{
                          borderRadius: activeTab === 'performance' ? '1rem 2rem 1rem 2rem / 1rem 1.5rem 1rem 1.5rem' : '1rem'
                        }}>
            ...
            <TabsTrigger value="insights"
                        ...
                        style={{
                          borderRadius: activeTab === 'insights' ? '1rem 2rem 1rem 2rem / 1rem 1.5rem 1rem 1.5rem' : '1rem'
                        }}>
        ...
        <TabsContent value="live-ops" className="space-y-8">
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent blur-2xl"
                 style={{
            ...
            <div className="relative bg-gradient-to-br from-card/95 via-card/80 to-card/60 backdrop-blur-2xl border border-primary/20 shadow-2xl p-8"
                 style={{
                   borderRadius: '2rem 4rem 2rem 4rem / 1.5rem 3rem 1.5rem 3rem'
                 }}>
        ...
        <TabsContent value="business-intel" className="space-y-8">
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-blue-500/20 via-blue-500/10 to-transparent blur-2xl"
                 style={{
                   borderRadius: '30% 70% 40% 60% / 60% 30% 70% 40%'
                 }}></div>
            <div className="relative bg-gradient-to-br from-card/95 via-card/80 to-card/60 backdrop-blur-2xl border border-blue-500/20 shadow-2xl p-8"
                 style={{
                   borderRadius: '2rem 4rem 2rem 4rem / 1.5rem 3rem 1.5rem 3rem'
                 }}>
              <div className="flex items-center gap-3 mb-6">
        ...
        <TabsContent value="performance" className="space-y-8">
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-yellow-500/20 via-yellow-500/10 to-transparent blur-2xl"
                 style={{
                   borderRadius: '50% 70% 50% 80% / 40% 60% 70% 30%'
                 }}></div>
            <div className="relative bg-gradient-to-br from-card/95 via-card/80 to-card/60 backdrop-blur-2xl border border-yellow-500/20 shadow-2xl p-8"
                 style={{
                   borderRadius: '2rem 4rem 2rem 4rem / 1.5rem 3rem 1.5rem 3rem'
                 }}>
              <div className="flex items-center gap-3 mb-6">
        ...
        <TabsContent value="insights" className="space-y-8">
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-purple-500/20 via-purple-500/10 to-transparent blur-2xl"
                 style={{
                   borderRadius: '60% 40% 70% 30% / 30% 70% 40% 60%'
                 }}></div>
            <div className="relative bg-gradient-to-br from-card/95 via-card/80 to-card/60 backdrop-blur-2xl border border-purple-500/20 shadow-2xl p-8"
                 style={{
                   borderRadius: '2rem 4rem 2rem 4rm / 1.5rem 3rem 1.5rem 3rem'
                 }}>
              <div className="flex items-center gap-3 mb-6">
