...
const ProcessSection = () => {
  return (
    <section className="bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 py-8 md:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="space-y-8 md:space-y-16">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 md:gap-12">
            <div className="flex-1 space-y-2 md:space-y-6 text-center lg:text-left">
              <div className="flex items-center gap-2 md:gap-4 justify-center lg:justify-start">
                <div className="w-8 h-8 md:w-12 md:h-12 text-white rounded-full flex items-center justify-center font-bold text-sm md:text-lg bg-gradient-to-br from-emerald-500 to-green-500">
                  1
                </div>
                <h3 className="text-lg md:text-2xl font-bold text-white">Customer Starts WhatsApp Chat</h3>
              </div>
              <p className="text-xs md:text-lg text-slate-300 leading-relaxed px-4 lg:px-0">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-2 md:p-4 backdrop-blur-sm mx-4 lg:mx-0">
                <p className="font-medium text-emerald-400 text-xs md:text-base">✨ No apps to download, no complex forms to fill out</p>
              </div>
            </div>
            
            <div className="flex-1 animate-appear opacity-100 delay-300 w-full max-w-sm lg:max-w-none">
              <WhatsAppChat />
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-4 md:gap-12">
            <div className="flex-1 space-y-2 md:space-y-6 text-center lg:text-left">
              <div className="flex items-center gap-2 md:gap-4 justify-center lg:justify-start">
                <div className="w-8 h-8 md:w-12 md:h-12 text-white rounded-full flex items-center justify-center font-bold text-sm md:text-lg bg-gradient-to-br from-blue-500 to-indigo-500">
                  2
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-2 md:p-4 backdrop-blur-sm mx-4 lg:mx-0">
                <p className="font-medium text-blue-400 text-xs md:text-base">📅 Syncs with Google Calendar, Outlook and more</p>
              </div>
            </div>
            
            <div className="flex-1 animate-appear opacity-100 delay-700 w-full max-w-sm lg:max-w-none">
              <CalendarMockup />
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 md:mt-24 space-y-3 md:space-y-8">
          <div className="text-center">
            <div className="flex items-center gap-2 md:gap-4 justify-center mb-3 md:mb-6">
              <div className="w-8 h-8 md:w-12 md:h-12 text-white rounded-full flex items-center justify-center font-bold text-sm md:text-lg bg-gradient-to-br from-purple-500 to-pink-500">
                3
              </div>
              <h3 className="text-lg md:text-2xl font-bold text-white">Test The AI Agent Yourself</h3>
            </div>
            <p className="text-xs md:text-lg text-slate-300 leading-relaxed max-w-3xl mx-auto mb-4 md:mb-8 px-4 sm:px-0">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-3 md:p-8 mx-4 sm:mx-0">
            <AIAgentTestChat />
          </div>
        </div>
      </div>
