...
export function ServicePerformanceChart({ data, selectedTimeRange }: ServicePerformanceChartProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-gradient-to-br from-card/90 via-background/80 to-card/90 backdrop-blur-2xl border border-orange-500/30 rounded-2xl shadow-2xl overflow-visible">
