...
const SocialProof = () => {
  ...
  return (
    <section className="py-8 md:py-20 px-4 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-3 md:mb-6 px-4 sm:px-0">
            Trusted by <span className="text-emerald-400">1000+ Businesses</span>
          </h2>
          <p className="text-sm md:text-xl text-slate-300 px-4 sm:px-0">Join successful businesses that are already automating their bookings</p>
        </div>
        
        {/* Testimonials grid - Compact mobile cards */}
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-4 md:p-8 text-center mx-4 sm:mx-0">
