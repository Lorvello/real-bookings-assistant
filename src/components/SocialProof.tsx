    ...
    <section className="py-12 md:py-24 px-3 md:px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 md:mb-20">
          <h2 className="text-xl md:text-5xl font-bold text-slate-700 mb-4 md:mb-6 px-3 sm:px-0">
            Trusted by <span className="text-emerald-500">10,000+</span> Businesses
          </h2>
          <p className="text-sm md:text-xl text-slate-500 max-w-3xl mx-auto px-3 sm:px-0">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="text-center group hover:transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-2xl md:text-4xl font-bold text-emerald-500 mb-2 group-hover:text-emerald-400 transition-colors">
                  {stat.value}
                </div>
                <div className="text-slate-500 text-sm md:text-base group-hover:text-slate-400 transition-colors">
                  {stat.label}
                </div>
              </div>
            );
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 md:p-8 hover:transform hover:scale-105 transition-all duration-300 cursor-pointer">
              <div className="flex items-center mb-4 md:mb-6">
                ...
                <div className="flex-1">
                  <h4 className="text-slate-800 font-semibold text-sm md:text-base">{testimonial.name}</h4>
                  <p className="text-slate-600 text-xs md:text-sm">{testimonial.business}</p>
              ...
              <div className="flex items-center mb-3 md:mb-4">
                ...
                <span className="ml-2 text-emerald-500 font-semibold text-xs md:text-sm">
                  {testimonial.stats}
                </span>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed pl-4">
            ...
            <div className="flex pb-4">
              {testimonials.map((testimonial, index) => (
                 <div key={index} className="w-[calc(100vw-2rem)] flex-none snap-start snap-always mx-4">
                   <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 h-full">
                     <div className="flex items-center mb-4">
                       ...
                       />
                       <div className="flex-1">
                         <h4 className="text-slate-800 font-semibold text-sm">{testimonial.name}</h4>
                         <p className="text-slate-600 text-xs">{testimonial.business}</p>
                         <div className="flex items-center mt-1">
                           <MapPin className="w-3 h-3 text-slate-500 mr-1" />
                           <span className="text-slate-500 text-xs">{testimonial.location}</span>
                         </div>
                     ...
                     <div className="flex items-center mb-3">
                       ...
                       <span className="ml-2 text-emerald-500 font-semibold text-xs">
                         {testimonial.stats}
                       </span>
                     </div>
                     ...
                     <div className="relative">
                       <Quote className="absolute -top-2 -left-2 w-6 h-6 text-emerald-400/30" />
                       <p className="text-slate-700 text-xs leading-relaxed pl-4">
                         {testimonial.testimonial}
                       </p>
                     </div>
