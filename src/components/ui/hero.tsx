    ...
    return (
      ...
      >
        ...
        {ctaText && ctaLink && (
          <a href={ctaLink}>
            <div 
              className="inline-flex items-center bg-black text-white rounded-[10px] hover:bg-black/90 transition-colors font-instrument-sans w-[272px] h-[58px] animate-appear opacity-0 delay-500"
            >
