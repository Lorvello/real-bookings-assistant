  ...
  return (
    <section className={className}>
      ...
      <div className="relative">
        ...
        <div className="container max-w-5xl mx-auto px-8 lg:px-16 relative z-10">
