          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <div className="p-3 md:p-10 rounded-2xl md:rounded-3xl border shadow-lg shadow-primary/10 max-w-[280px] md:max-w-xs w-full" key={i}>
    ...
    <section className="py-8 md:py-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-[10px] md:text-lg text-slate-300 max-w-3xl mx-auto px-3 sm:px-0">
