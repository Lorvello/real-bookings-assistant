    ...
    <section className="py-section px-6 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid-responsive-3 mb-16">
          <div className="card-default group hover:shadow-xl hover:shadow-destructive/5 transition-all duration-500 hover:-translate-y-1">
            <div className="w-12 h-12 bg-destructive/10 rounded-card flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              <Phone className="w-6 h-6 text-destructive" strokeWidth={2} />
            </div>
          ...
          <div className="card-default group hover:shadow-xl hover:shadow-destructive/5 transition-all duration-500 hover:-translate-y-1">
            <div className="w-12 h-12 bg-destructive/10 rounded-card flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              <Calendar className="w-6 h-6 text-destructive" strokeWidth={2} />
            </div>
            <h3 className="text-lg font-bold text-foreground mb-3">
          ...
          <div className="card-default group hover:shadow-xl hover:shadow-destructive/5 transition-all duration-500 hover:-translate-y-1">
            <div className="w-12 h-12 bg-destructive/10 rounded-card flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
              <Clock className="w-6 h-6 text-destructive" strokeWidth={2} />
            </div>
            <h3 className="text-lg font-bold text-foreground mb-3">
        ...
        <div className="card-default text-center relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-base md:text-lg font-medium mb-4 max-w-2xl mx-auto leading-relaxed text-foreground">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                <div className="font-semibold text-foreground text-sm">Sarah</div>
                <div className="text-muted-foreground text-xs">Wellness Coach</div>
              </div>
            </div>
          </div>
        </div>
