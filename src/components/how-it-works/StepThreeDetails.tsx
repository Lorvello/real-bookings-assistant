    ...
    <div className="relative group">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-2 md:gap-4 mb-3 md:mb-6">
          <div className="relative">
            <div className="w-6 h-6 md:w-10 md:h-10 bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 
              ...
              <span className="text-white text-sm md:text-lg font-bold relative z-10">3</span>
            </div>
          </div>
        ...
        <div className="space-y-1 md:space-y-2 mb-3 md:mb-4">
           <div className="flex items-start gap-2 md:gap-4 p-2 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative mt-1">
              <Bot className="w-4 h-4 md:w-6 md:h-6 text-emerald-400 drop-shadow-sm" />
              <div className="absolute inset-0 bg-emerald-400/20 rounded-full blur-sm -z-10"></div>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm md:text-base mb-1">Instant activation</h4>
           ...
           <div className="flex items-start gap-2 md:gap-4 p-2 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative mt-1">
              <Sparkles className="w-4 h-4 md:w-6 md:h-6 text-emerald-400 drop-shadow-sm" />
              <div className="absolute inset-0 bg-emerald-400/20 rounded-full blur-sm -z-10"></div>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm md:text-base mb-1">Optional customization</h4>
           ...
           <div className="flex items-start gap-2 md:gap-4 p-2 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative mt-1">
              <CheckCircle className="w-4 h-4 md:w-6 md:h-6 text-emerald-400 drop-shadow-sm" />
              <div className="absolute inset-0 bg-emerald-400/20 rounded-full blur-sm -z-10"></div>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm md:text-base mb-1">24/7 ready to serve</h4>
        ...
        <div className="bg-gradient-to-r from-emerald-500/20 via-emerald-500/15 to-emerald-600/10 
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
              ...
              <span className="text-emerald-200 font-bold text-base md:text-lg tracking-wide">Live Status</span>
            </div>
        ...
        <div className="bg-gradient-to-br from-slate-800/60 via-slate-800/40 to-slate-900/60 
          ...
          <div className="space-y-3 md:space-y-6 relative z-10">
            <div className="text-center">
              ...
              <h4 className="text-lg md:text-xl font-bold text-white tracking-wide">System Active</h4>
            </div>
