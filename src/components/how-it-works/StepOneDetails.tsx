    ...
    <div className="relative group">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-2 md:gap-4 mb-3 md:mb-6">
          <div className="relative">
            <div className="w-6 h-6 md:w-10 md:h-10 bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 
              ...
              <span className="text-white text-sm md:text-lg font-bold relative z-10">1</span>
            </div>
          </div>
        ...
        <div className="space-y-1 md:space-y-2">
          <div className="flex items-center gap-2 md:gap-4 p-2 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
            ...
            <span className="text-slate-100 font-medium text-sm md:text-base">Instant professional calendar setup</span>
          </div>
           <div className="flex items-center gap-2 md:gap-4 p-2 md:p-2 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative">
              <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-emerald-400 drop-shadow-sm" />
              <div className="absolute inset-0 bg-emerald-400/20 rounded-full blur-sm -z-10"></div>
            </div>
            <span className="text-slate-100 font-medium text-sm md:text-base">Option to connect existing calendar</span>
          </div>
           <div className="flex items-center gap-2 md:gap-4 p-2 md:p-2 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative">
            ...
            <span className="text-slate-100 font-medium text-sm md:text-base">Immediate setup - no waiting</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-br from-slate-800/60 via-slate-800/40 to-slate-900/60 
          ...
          <div className="text-center relative z-10">
            ...
            <div className="relative mb-3 md:mb-6 inline-block">
              <div className="relative">
                <Calendar className="w-10 h-10 md:w-16 md:h-16 text-emerald-400 mx-auto drop-shadow-lg" />
            ...
            <h4 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-6 tracking-wide">Calendar Ready</h4>
