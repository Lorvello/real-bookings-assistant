      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-1 md:gap-4 mb-2 md:mb-6">
          ...
          <div className="flex flex-col">
            <span className="text-emerald-300 font-semibold text-xs md:text-sm uppercase tracking-wider">{t('hiw.step1.eyebrow', 'Step One')}</span>
        ...
        <h3 className="text-base md:text-2xl xl:text-3xl font-bold mb-1 md:mb-4 leading-tight tracking-tight
          ...
          {t('hiw.step1.title', 'Create account & get your professional calendar')}
        </h3>

        <p className="text-slate-300 text-[10px] md:text-base mb-2 md:mb-4 leading-relaxed font-light">
          {t('hiw.step1.desc', 'Simply create your account and get instant access to your professional calendar system. You can also connect your existing calendar if you prefer.')}
        </p>
        ...
        <div className="space-y-1 md:space-y-2">
          <div className="flex items-center gap-1 md:gap-4 p-1 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
            ...
            <span className="text-slate-100 font-medium text-xs md:text-base">{t('hiw.step1.feature1', 'Instant professional calendar setup')}</span>
          </div>
           <div className="flex items-center gap-1 md:gap-4 p-1 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative">
            ...
            <span className="text-slate-100 font-medium text-xs md:text-base">{t('hiw.step1.feature2', 'Option to connect existing calendar')}</span>
          </div>
           <div className="flex items-center gap-1 md:gap-4 p-1 md:p-3 rounded-lg md:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10
                        transition-all duration-300 hover:bg-white/10 hover:border-emerald-400/30">
            <div className="relative">
            ...
            <span className="text-slate-100 font-medium text-xs md:text-base">{t('hiw.step1.feature3', 'Immediate setup - no waiting')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10">
        <div className="bg-gradient-to-br from-slate-800/60 via-slate-800/40 to-slate-900/60 
          ...
          <div className="text-center relative z-10">
            ...
            <h4 className="text-sm md:text-xl font-bold text-white mb-2 md:mb-6 tracking-wide">{t('hiw.step1.visualTitle', 'Calendar Ready')}</h4>
            ...
            <div className="space-y-1 md:space-y-3">
              <div className="flex items-center justify-between p-1 md:p-4 
                ...
                <span className="text-slate-100 text-xs md:text-sm font-medium">{t('hiw.step1.visualRow', 'Professional Calendar')}</span>
                <div className="relative">
              ...
              <div className="bg-gradient-to-r from-emerald-500/20 via-emerald-500/15 to-emerald-600/10 
                ...
                <div className="flex items-center justify-center gap-1 md:gap-3 relative z-10">
                  ...
                  <span className="text-emerald-200 text-xs md:text-sm font-semibold tracking-wide">{t('hiw.step1.visualBadge', 'Instantly Active')}</span>
                </div>
