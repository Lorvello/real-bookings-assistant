    ...
    <div className="relative group">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-2 md:gap-4 mb-3 md:mb-6">
          <div className="relative">
            <div className="w-6 h-6 md:w-10 md:h-10 bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 
              ...
              <span className="text-white text-sm md:text-lg font-bold relative z-10">2</span>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-emerald-300 font-semibold text-xs md:text-sm uppercase tracking-wider">Step Two</span>
            <div className="w-8 md:w-12 h-0.5 bg-gradient-to-r from-emerald-400 to-transparent mt-1"></div>
          </div>
        </div>
        
        {/* Premium Typography - Mobile: much smaller */}
        <h3 className="text-lg md:text-2xl xl:text-3xl font-bold mb-2 md:mb-4 leading-tight tracking-tight
                     bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent">
          Get your WhatsApp number instantly
        </h3>
        
        <p className="text-slate-300 text-sm md:text-base mb-3 md:mb-4 leading-relaxed font-light">
        ...
        <div className="space-y-2 md:space-y-3 mb-3 md:mb-4">
          <div className="bg-gradient-to-r from-emerald-500/15 via-emerald-500/10 to-emerald-600/5 
                        border border-emerald-400/30 p-2 md:p-4 rounded-lg md:rounded-xl backdrop-blur-sm
            ...
            <div className="absolute top-2 right-2 md:top-4 md:right-4">
              <Star className="w-4 h-4 md:w-5 md:h-5 text-emerald-400 fill-current drop-shadow-sm" />
            </div>
            <div className="relative z-10">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <Shield className="w-4 h-4 md:w-6 md:h-6 text-emerald-400" />
                <h4 className="text-base md:text-lg font-bold text-white">Instant number assignment</h4>
                <span className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-2 py-0.5 md:px-3 md:py-1 rounded-full text-xs font-bold tracking-wide shadow-lg">
                  Automatic
                </span>
              </div>
              <p className="text-emerald-100 text-xs md:text-sm mb-2 md:mb-3 leading-relaxed">
          ...
          <div className="bg-gradient-to-r from-slate-700/60 via-slate-700/40 to-slate-800/60 
                        border border-slate-500/30 p-2 md:p-4 rounded-lg md:rounded-xl backdrop-blur-sm
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <MessageSquare className="w-4 h-4 md:w-6 md:h-6 text-emerald-400" />
                <h4 className="text-base md:text-lg font-bold text-white">Connect existing number</h4>
              </div>
              <p className="text-slate-200 text-xs md:text-sm mb-2 md:mb-3 leading-relaxed">
      ...
      <div className="relative z-10">
        <div className="bg-gradient-to-br from-slate-800/60 via-slate-800/40 to-slate-900/60 
                      border border-slate-600/50 rounded-xl md:rounded-2xl p-3 md:p-6 backdrop-blur-sm
          ...
          <div className="text-center relative z-10">
            ...
            <div className="relative mb-3 md:mb-6 inline-block">
              <div className="relative">
                <MessageCircle className="w-10 h-10 md:w-16 md:h-16 text-emerald-400 mx-auto drop-shadow-lg" />
            ...
            <h4 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-6 tracking-wide">WhatsApp Ready</h4>
            ...
            <div className="space-y-2 md:space-y-3">
              <div className="bg-gradient-to-r from-emerald-500/20 via-emerald-500/15 to-emerald-600/10 
                            border border-emerald-400/40 p-2 md:p-4 rounded-lg md:rounded-xl
                            shadow-sm md:shadow-lg shadow-emerald-500/10
                            relative overflow-hidden">
                <div className="flex items-center justify-center gap-2 md:gap-3 mb-1 md:mb-2 relative z-10">
                ...
                <p className="text-emerald-100 text-xs font-mono bg-emerald-500/10 px-2 py-1 md:px-3 md:py-1 rounded-lg inline-block">
                  +31 6 12345678
                </p>
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/5 to-transparent"></div>
              </div>
              ...
              <div className="bg-gradient-to-r from-slate-700/60 to-slate-600/40 
                            border border-slate-500/30 p-2 md:p-4 rounded-lg md:rounded-xl
