...
export function CalendarHeader({
  ...
  return (
    <div className="bg-gradient-to-r from-card/95 via-card to-card/95 backdrop-blur-xl border-b border-border/40 px-4 sm:px-6 py-4 rounded-t-3xl shadow-lg shadow-black/5">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
          <div className="flex items-center space-x-3 px-4 py-3 bg-primary/5 rounded-lg border">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-foreground bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">
                {formatTitle()}
              </h1>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
          ...
          <div className="flex items-center bg-muted/50 rounded-2xl p-1.5 border border-border/60 shadow-sm">
            {(['month', 'week', 'year'] as const).map((view) => (
              <Button
                ...
                className={`px-3 sm:px-4 py-2 h-9 rounded-xl font-medium transition-all duration-200 text-sm ${
                  currentView === view 
          ...
          <div className="flex items-center">
            <Button
              ...
              disabled={loading}
              className="h-11 px-4 sm:px-6 rounded-2xl bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-primary-foreground font-semibold shadow-lg shadow-primary/25 transition-all duration-200 hover:shadow-xl hover:shadow-primary/30 hover:scale-105 text-sm"
            >
