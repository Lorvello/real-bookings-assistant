                ...
                >
                  <div className={`flex items-center justify-between mb-1 ${
                    ...
                    {dayBookings.length > 0 && (
                      <div className="text-xs bg-primary/15 text-accent-foreground px-1 py-0.5 rounded-full font-medium tabular-nums">
                        {dayBookings.length}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    {dayBookings.length === 1 && (
                      <div
                        ...
                        style={{
                          backgroundColor: dayBookings[0].service_types?.color || '#22AB72',
                          backgroundImage: `linear-gradient(135deg, ${dayBookings[0].service_types?.color || '#22AB72'}, ${dayBookings[0].service_types?.color || '#22AB72'}dd)`
                        }}
                    ...
                    {dayBookings.length > 1 && (
                      <div className="text-center py-2 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg border border-primary/20 hover:from-primary/20 hover:to-primary/10 hover:border-primary/30 transition-all duration-200 cursor-pointer group-hover:scale-105">
                        <div className="text-accent-foreground font-semibold text-xs mb-0.5 tabular-nums">
