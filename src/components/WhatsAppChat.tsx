    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className="relative bg-black rounded-[2.5rem] p-2 shadow-2xl">
        ...
        <div className="bg-background-secondary rounded-[2rem] overflow-hidden">
          {/* WhatsApp header - updated with design system colors */}
          ...
          {/* Chat messages - updated with design system */}
          <div className="bg-background min-h-[400px] p-3 space-y-3">
            ...
            <div className="flex justify-end">
              <div className="chat-bubble-outbound">
                ...
                <p className="chat-timestamp">10:30</p>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <div className="chat-bubble-outbound">
                ...
                <p className="chat-timestamp">10:31</p>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <div className="chat-bubble-outbound">
                ...
                <p className="chat-timestamp">10:32</p>
              </div>
            </div>
          </div>
        </div>
