              ...
              >
                <div className={`relative rounded-3xl border h-full flex flex-col transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl ${
                  ...
                  <div className="p-6 text-center relative z-10">
                    ...
                    <p className="text-slate-400 text-base leading-relaxed font-garamond font-light">{plan.description}</p>
                  </div>
                           ...
                           <Tooltip>
                            <TooltipTrigger asChild>
                              <div className="flex-1 cursor-help relative">
                                <span className="text-slate-400 text-base leading-relaxed font-garamond font-light hover:text-slate-200 transition-colors pr-4">
                                  {feature.text}
                                </span>
                    ...
                    >
                      <div className={`rounded-2xl border overflow-hidden relative flex flex-col backdrop-blur-xl ${
                        ...
                        <div className={`p-3.5 text-center relative z-10 ${plan.popular ? 'pt-10' : 'pt-4'}`}>
                          ...
                          <p className="text-slate-400 text-xs leading-tight px-1 font-garamond font-light">{plan.description}</p>
                        </div>
                              ...
                              <div key={idx} className="flex items-start space-x-2">
                                <div className="w-3.5 h-3.5 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm shadow-emerald-400/30">
                                 ...
                                 <div className="flex-1">
                                   <span className="text-slate-200/95 text-xs leading-tight font-garamond font-light tracking-wide">
                                     {feature.text}
                                   </span>
                                 </div>
                              </div>
