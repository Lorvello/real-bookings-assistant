...
const PsychologyDataDisclaimer: React.FC<PsychologyDataDisclaimerProps> = ({ onMethodologyClick }) => {
  return (
    <div className="-mt-4 pb-4 text-center">
      <p className="text-slate-400 text-[9px] sm:text-sm mb-1 sm:mb-2 font-medium">
        <span className="inline-block w-1.5 sm:w-2 h-1.5 sm:h-2 bg-emerald-400 rounded-full mr-1 sm:mr-2"></span>
