  ...
  return (
    <div className="-mt-4 pb-4 text-center">
      <p className="text-slate-400 text-[8px] sm:text-sm mb-1 sm:mb-2 font-medium">
        ...
        {t('whyus.psychDisclaimer.text', 'Based on behavioral psychology research from 10,000+ businesses across 15 countries')}
      </p>
      ...
      <div className="flex flex-row sm:flex-row items-center justify-center gap-1 sm:gap-6 text-[7px] sm:text-xs text-slate-400">
        ...
        <span>{t('whyus.psychDisclaimer.tag1', 'Consumer behavior analysis')}</span>
        <span className="inline sm:inline text-slate-600">•</span>
        <span>{t('whyus.psychDisclaimer.tag2', 'Cross-cultural validation')}</span>
      </div>
    </div>
  );
};
