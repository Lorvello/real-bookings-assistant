...
const Features = () => {
  const bookingFeatures = [{
    ...
    className: "lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-2 min-h-[29rem]"
  }, {
    Icon: CalendarIcon,
    ...
    className: "lg:col-start-2 lg:col-end-3 lg:row-start-2 lg:row-end-3 min-h-[29rem]"
  }, {
    Icon: BellIcon,
