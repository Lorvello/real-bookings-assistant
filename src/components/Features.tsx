  ...
  const bookingFeatures = [{
    ...
    background: <div className="absolute inset-0">
          ...
          <div className="absolute top-3 left-3 right-3 bottom-3 bg-slate-800/50 rounded-lg border border-slate-700/50 p-3 backdrop-blur-sm overflow-hidden">
            ...
            <div className="bg-gray-800/90 rounded-lg shadow-sm border border-gray-700/50 p-3 mb-2">
              {/* WhatsApp App Header */}
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gray-800/90 rounded-lg shadow-sm border border-gray-700/50 p-3 transform translate-y-16">
              ...
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-gray-500 text-xs">25m ago</span>
              </div>
              
              {/* Sender Name */}
              <div className="mb-1">
                <span className="text-white text-sm font-medium">Dental Practice</span>
              </div>
              
              {/* Message Preview */}
              <div className="text-gray-200 text-xs leading-relaxed">
                📅 Appointment confirmed for Thursday at 10:30 AM...
              </div>
            </div>
          </div>
