...
const Features = () => {
  return (
    <section className="py-12 md:py-16 px-3 md:px-4 relative overflow-hidden" style={{
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <div className="text-center">
            <h2 className="text-lg md:text-3xl xl:text-4xl font-bold text-white mb-4 md:mb-6 px-3 sm:px-0">
