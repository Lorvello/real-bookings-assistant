...
const Features = () => {
  ...
  const bookingFeatures = [{
    ...
    background: <div className="absolute inset-0">
          ...
          {/* Authentic WhatsApp Notification */}
          <div className="absolute top-3 left-3 right-3 bg-gray-50 rounded-lg shadow-sm border border-gray-100 p-3">
            {/* WhatsApp App Header */}
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-xs uppercase font-medium tracking-wide">WhatsApp</span>
              </div>
              <span className="text-gray-400 text-xs">13m ago</span>
            </div>
            
            {/* Sender Name */}
            <div className="mb-1">
              <span className="text-gray-900 text-sm font-medium">Wellness Clinic</span>
            </div>
