              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    ...
                    <span className="text-muted-foreground text-sm">Financial commitment creates psychological ownership</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Customers value appointments they've already paid for</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Reduces casual "just in case" bookings</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Creates accountability for both sides</span>
                  </div>
                </div>
              </ScrollAnimatedSection>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Immediate revenue recognition</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Eliminates collection delays</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Reduces accounts receivable overhead</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Improves working capital and cash flow predictability</span>
                  </div>
                </div>
              </ScrollAnimatedSection>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm"><span className="font-medium text-emerald-400">PCI DSS Level 1</span> - Highest card security level</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm"><span className="font-medium text-emerald-400">ISO 27001</span> - International security management standard</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm"><span className="font-medium text-emerald-400">SOC 1 & SOC 2 Type II</span> - Operational compliance</span>
                  </div>
                </div>
              </ScrollAnimatedSection>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">PSD2 & GDPR Compliant (EU regulations)</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">KYC/AML Checks (Anti-money laundering)</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">47+ Countries (Local banking regulations)</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">End-to-end Encryption (Transaction security)</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Fraud Detection (Advanced prevention)</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">24/7 Monitoring (Threat detection)</span>
                  </div>
                </div>
              </ScrollAnimatedSection>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Customers see upfront payment as a sign of professionalism</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Higher perceived reliability increases repeat bookings</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/[0.03] rounded-lg border border-white/[0.08]">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                    <span className="text-muted-foreground text-sm">Transparent policies build brand trust and loyalty</span>
                  </div>
                </div>
              </ScrollAnimatedSection>
