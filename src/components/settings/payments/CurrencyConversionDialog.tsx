...
const POINTS: { text: string; positive?: boolean }[] = [
  { text: 'Stripe applies an extra 2% fee if the payment currency differs from your account currency.' },
  { text: 'Example: a UK customer pays £100 in GBP → funds are converted to EUR with a 2% markup on the exchange rate.' },
  { text: 'This fee is charged on top of the normal payment processing fee.' },
  { text: 'Customers always see the charge in their own currency; the conversion happens on your side as the merchant.' },
  { text: 'If the customer pays in the same currency as your account (e.g. EUR), this fee does not apply.', positive: true },
];
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-2 rounded-xl border border-primary/20 bg-primary/[0.05] p-3">
            ...
            <span className="text-sm font-medium text-foreground">
              Tip: to avoid this fee, charge in the same currency as your Stripe account.
            </span>
          </div>
        </div>
      </DialogContent>
