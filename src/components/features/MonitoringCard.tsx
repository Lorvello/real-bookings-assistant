            ...
            <div className="flex h-20 gap-3 px-2 mt-4">
              ...
              <div className="flex-1">
                <div className="h-full bg-emerald-600/20 border border-emerald-500/30 rounded-lg p-3 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 ease-out hover:scale-110 hover:bg-emerald-600/40 hover:border-emerald-500/60 hover:shadow-lg hover:shadow-emerald-500/25 transform group">
                  ...
                  <div className="text-emerald-300 text-xs font-medium mb-1 group-hover:text-emerald-200 transition-colors duration-300">{t('bento.monitoring.today', 'Today')}</div>
                  ...
                  <div className="text-emerald-400 text-[6px] mt-1 opacity-70 group-hover:opacity-100 group-hover:text-emerald-300 transition-all duration-300">{t('bento.monitoring.todayRevenue', '€375 revenue')}</div>
                </div>
              </div>
              ...
              <div className="flex-1">
                <div className="h-full bg-emerald-600/20 border border-emerald-500/30 rounded-lg p-3 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 ease-out hover:scale-110 hover:bg-emerald-600/40 hover:border-emerald-500/60 hover:shadow-lg hover:shadow-emerald-500/25 transform group">
                  ...
                  <div className="text-emerald-300 text-xs font-medium mb-1 group-hover:text-emerald-200 transition-colors duration-300">{t('bento.monitoring.activeNow', 'Active Now')}</div>
                  ...
                  <div className="text-emerald-400 text-[6px] mt-1 opacity-70 group-hover:opacity-100 group-hover:text-emerald-300 transition-all duration-300">{t('bento.monitoring.confirmedCount', '2 confirmed')}</div>
                </div>
              </div>
              ...
              <div className="flex-1">
                <div className="h-full bg-emerald-600/20 border border-emerald-500/30 rounded-lg p-3 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 ease-out hover:scale-110 hover:bg-emerald-600/40 hover:border-emerald-500/60 hover:shadow-lg hover:shadow-emerald-500/25 transform group">
                  ...
                  <div className="flex justify-center gap-0.5">
                    <div className="text-emerald-400 text-[6px] group-hover:text-emerald-300 transition-colors duration-300">{t('bento.monitoring.messagesIn', '12 in')}</div>
                    <div className="text-emerald-300 text-[6px] group-hover:text-emerald-200 transition-colors duration-300">•</div>
                    <div className="text-emerald-400 text-[6px] group-hover:text-emerald-300 transition-colors duration-300">{t('bento.monitoring.messagesOut', '5 out')}</div>
                  </div>
                  <div className="text-emerald-400 text-[6px] opacity-70 group-hover:opacity-100 group-hover:text-emerald-300 transition-all duration-300">{t('bento.monitoring.avgResponse', '2m avg response')}</div>
                </div>
              </div>
            </div>
          </div>
