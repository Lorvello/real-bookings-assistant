        ...
        <div className="bg-gray-800/90 rounded-lg shadow-sm border border-gray-700/50 p-3 cursor-pointer transition-all duration-300 ease-out hover:scale-105 hover:bg-gray-800 hover:border-gray-600/70 hover:shadow-lg hover:shadow-emerald-500/20 transform">
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-400 text-xs uppercase font-medium tracking-wide">{t('featureCards.reminders.whatsapp')}</span>
            </div>
          ...
          {/* Sender Name */}
          <div className="mb-1">
            <span className="text-white text-sm font-medium">{t('featureCards.reminders.clinicName')}</span>
          </div>
          
          {/* Message Preview */}
          <div className="text-gray-200 text-xs leading-relaxed">
            {t('featureCards.reminders.reminderMessage')}
          </div>
        </div>
      </div>
