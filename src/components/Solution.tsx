...
const Solution = () => {
  return (
    <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-3 py-2 sm:px-6 sm:py-3 mb-4 sm:mb-6 md:mb-8 backdrop-blur-sm">
            <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
            <span className="text-emerald-300 text-xs sm:text-sm font-medium">The Solution</span>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-3 sm:mb-4 md:mb-6 leading-tight px-2 sm:px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 md:gap-16">
          ...
          <div className="group text-center hover:transform hover:scale-105 transition-all duration-300 cursor-pointer px-4 sm:px-0">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3 sm:mb-4 leading-tight group-hover:text-emerald-300 transition-colors duration-300">
              Instant WhatsApp Responses
            </h3>
            <p className="text-slate-300 text-sm sm:text-base md:text-lg leading-relaxed max-w-sm mx-auto group-hover:text-slate-200 transition-colors duration-300 mb-4 sm:mb-6">
            ...
            <div className="flex items-center justify-center text-emerald-400 font-semibold text-xs sm:text-sm md:text-base">
          ...
          <div className="group text-center hover:transform hover:scale-105 transition-all duration-300 cursor-pointer px-4 sm:px-0">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3 sm:mb-4 leading-tight group-hover:text-blue-300 transition-colors duration-300">
              Smart Conversations
            </h3>
            <p className="text-slate-300 text-sm sm:text-base md:text-lg leading-relaxed max-w-sm mx-auto group-hover:text-slate-200 transition-colors duration-300 mb-4 sm:mb-6">
            ...
            <div className="flex items-center justify-center text-blue-400 font-semibold text-xs sm:text-sm md:text-base">
          ...
          <div className="group text-center hover:transform hover:scale-105 transition-all duration-300 cursor-pointer px-4 sm:px-0 md:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3 sm:mb-4 leading-tight group-hover:text-purple-300 transition-colors duration-300">
            ...
            <div className="flex items-center justify-center text-purple-400 font-semibold text-xs sm:text-sm md:text-base">
