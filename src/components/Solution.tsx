    ...
    <section className="py-16 px-6 bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-16">
          {/* Feature 1 */}
          <div className="group bg-card border border-border rounded-2xl p-6 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-1">
