  ...
  return (
    <div className="-mt-4 pb-4 text-center">
      <p className="text-slate-400 text-[8px] sm:text-sm mb-1 sm:mb-2 font-medium">
        ...
        {t('whyus.mobileDisclaimer.text', 'Based on mobile behavior analysis and customer preference research')}
      </p>
      ...
      <div className="flex flex-row items-center justify-center gap-1 sm:gap-3 text-[7px] sm:text-xs text-slate-400">
        ...
        <span>{t('whyus.mobileDisclaimer.tag1', 'Cross-platform user studies')}</span>
        <span className="inline sm:inline text-slate-600">•</span>
        <span>{t('whyus.mobileDisclaimer.tag2', 'Results may vary by demographics')}</span>
      </div>
    </div>
  );
};
