    ...
    <div className="space-y-1 md:space-y-6">
      ...
      <Card className="bg-card border border-border shadow-sm rounded-lg">
        ...
        <CardContent className="p-3 md:p-6 space-y-6">
          ...
          {/* Bookings Assistant Number */}
          <div className="text-center p-6 bg-muted/30 rounded-lg border border-border/20">
            <p className="text-xs font-medium uppercase tracking-widest text-muted-foreground/60 mb-4">Bookings Assistant Number</p>
      ...
      <Card className="bg-card border border-border shadow-sm rounded-lg">
        ...
        <CardContent className="p-3 md:p-6">
          <div className="bg-muted text-foreground p-4 rounded-lg border border-border/20">
